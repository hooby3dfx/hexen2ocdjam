...
void obj_ocd_table()
{
	precache_model("models/ocd_table.mdl");

	CreateEntityNew(self,ENT_OCD_TABLE,"models/ocd_table.mdl",chunk_death);
...
void obj_ocd_couch()
{
	precache_model("models/ocd_couch.mdl");

	CreateEntityNew(self,ENT_OCD_COUCH,"models/ocd_couch.mdl",chunk_death);
...
void obj_ocd_lamp()
{
	precache_model("models/ocd_lamp.mdl");

	CreateEntityNew(self,ENT_OCD_LAMP,"models/ocd_lamp.mdl",chunk_death);

	self.touch	= obj_push;
	self.flags	(+) FL_PUSH;
}
void obj_ocd_diningtable()
{
	precache_model("models/ocd_diningtable.mdl");

	CreateEntityNew(self,ENT_OCD_DININGTABLE,"models/ocd_diningtable.mdl",chunk_death);
